...
/**
 * Room entity for virtual environment profile persistence.
 * Stores all VE configuration and state data.
 */
@Entity(tableName = "ve_profiles")
data class VeProfileEntity(
    @PrimaryKey
    val id: String,
    val name: String,
